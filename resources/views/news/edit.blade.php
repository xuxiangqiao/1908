 ...
 <body>
    ...
    @csrf
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <select name="cate_id">
                            ...
                            @foreach($cate as $v)
                            <option value="{{$v->cate_id}}" @if($v->cate_id==$data->cate_id) selected="selected"  @endif >{{$v->cate_name}}</option>
                             @endforeach
                        </select>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" style="text-align:center;"><input type="button" value="修改"></td>
